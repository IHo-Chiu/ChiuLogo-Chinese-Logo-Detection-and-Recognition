...
# data options
train_data=${DATAPATH}/datasets/STR/lmdb/train
val_data=${DATAPATH}/datasets/STR/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=str_finetune_vit-b-16_roberta-base_bs64_1gpu
