...
# data options
train_data=${DATAPATH}/datasets/AmazonProduct/lmdb/train
val_data=${DATAPATH}/datasets/AmazonProduct/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=AmazonProduct_finetune_vit-b-16_roberta-base_bs128_8gpu
