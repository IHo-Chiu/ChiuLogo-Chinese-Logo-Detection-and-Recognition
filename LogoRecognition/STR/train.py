...
def main(config: DictConfig):
    ...
    with open_dict(config):
        ...
        if gpu and devices > 1:
            ...
            # DDP optimizations
            trainer_strategy = DDPStrategy(find_unused_parameters=config.find_unused_parameters, gradient_as_bucket_view=True)
    ...
    checkpoint = ModelCheckpoint(monitor='val_NED', mode='max', save_top_k=3, save_last=True,
