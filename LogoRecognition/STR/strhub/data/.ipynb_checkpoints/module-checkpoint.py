...
class SceneTextDataModule(pl.LightningDataModule):
    ...
    TEST_BENCHMARK = ('IIIT5k', 'SVT', 'IC13_1015', 'IC13_1095', 'IC15_2077', 'SVTP', 'CUTE80')
    TEST_NEW = ('ArT', 'COCOv1.4', 'Uber')
    TEST_CHINESE = ('scene_test', 'web_test', 'document_test')
    TEST_ALL = tuple(set(TEST_BENCHMARK_SUB + TEST_BENCHMARK + TEST_NEW + TEST_CHINESE))
